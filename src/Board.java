...
public class Board extends JPanel {
    ...
    private String[] tetrominoes = { "NoTetromino", "ZTetromino", "STetromino", "ITetromino", "TTetromino","OTetromino",
    "LTetromino", "JTetromino"
    };



    public Board(TetrisWindow parent) {
    ...
    private void doDrawing(Graphics g) {
        ...
        if (curPiece.getShape().toString() != "NoShape") {
    ...
    private void newPiece() {
        ...
        if (!tryMove(curPiece, curX, curY)) {
            ...
            curPiece.setShape(factory.createShape("NoTetromino"));
            timer.stop();
    ...
    private boolean tryMove(Shape newPiece, int newX, int newY) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (shapeAt(x, y).toString() != "NoTetromino") {
    ...
    private void removeFullLines() {
        ...
        for (int i = BOARD_HEIGHT - 1; i >= 0; i--) {
            ...
            for (int j = 0; j < BOARD_WIDTH; j++) {
                ...
                if (shapeAt(j, i).toString() == "NoTetromino") {
    ...
    private void drawSquare(Graphics g, int x, int y, Tetromino shape) {
        ...
        var color = colors[Arrays.asList(tetrominoes).indexOf(shape.toString())];
    ...
    class TAdapter extends KeyAdapter {
        ...
        public void keyPressed(KeyEvent e) {
            ...
            if (curPiece.getShape().toString() == "NoTetromino") {
